...
This implies that the network design should not be overly complex. Thus, the following aspects need to be considered:
 	Topology clarity.
 	VLAN numbering consistency.
 	IP addressing structure.
 	Identified devices and network segments.
...
This would entail:
 	Intra-departmental/intra network communication.
 	Inter-departmental/inter-network communication.
...
This requirement can be solved by the proposed design, which will provide:
 	Network connection to the new floor/area.
 	Proper switching infrastructure.
...
•	Make use of logical network segmentation through the use of VLANs to categories different functional areas.
•	Provide proper routing to ensure proper communication between different networks.
•	Provide the appropriate network services for the hypothetical company.
•	Ensure that the design is easy to manage since there is only one part-time IT support person available.
•	Account for the new floor/area needed due to CR2.
•	Properly test the connectivity using the appropriate Cisco packet tracer testing procedures.
•	Document the entire process of design, implementation, configuration, testing and troubleshooting in the individual GitHub portfolio.
